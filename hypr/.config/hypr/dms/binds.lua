...
hl.bind("CTRL" .. " + " .. "XF86AudioLowerVolume", hl.dsp.exec_cmd("dms ipc call mpris decrement 3"), { locked = true })

hl.bind("CTRL" .. " + " .. "XF86AudioRaiseVolume", hl.dsp.exec_cmd("dms ipc call mpris increment 3"), { locked = true })
...
hl.bind("SUPER" .. " + " .. "M", hl.dsp.exec_cmd("dms ipc call audio micmute"), { locked = true })

-- dms ipc call audio micmute

hl.bind("SUPER + SHIFT" .. " + " .. "M", hl.dsp.exec_cmd("dms ipc call audio cycleoutput"))
